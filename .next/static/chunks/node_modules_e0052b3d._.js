...
const notAnimatable = (color)=>"'".concat(color, "' is not an animatable color. Use the equivalent color code instead.");
...
function fastInterpolate(param, param1) {
    let [from, to] = param, [mixer] = param1;
...
function keyframes(param) {
    let { from = 0, to = 1, ease, offset, duration = 300 } = param;
    const state = {
        done: false,
        value: from
    };
...
function decay(param) {
    let { velocity = 0, from = 0, power = 0.8, timeConstant = 350, restDelta = 0.5, modifyTarget } = param;
    const state = {
        done: false,
        value: from
    };
...
function inertia(param) {
    let { from = 0, velocity = 0, min, max, power = 0.8, timeConstant = 750, bounceStiffness = 500, bounceDamping = 10, restDelta = 1, modifyTarget, driver, onUpdate, onComplete, onStop } = param;
...
const angle = function(a) {
    let b = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : zeroPoint;
...
const createAttractor = function() {
    let alterDisplacement = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : identity;
...
const smoothFrame = function(prevValue, nextValue, duration) {
    let smoothing = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 0;
    return toDecimal(prevValue + duration * (nextValue - prevValue) / Math.max(smoothing, duration));
};
const smooth = function() {
    let strength = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 50;
    let previousValue = 0;
    let lastUpdated = 0;
    return (v)=>{
...
const calcDampingRatio = function() {
    let stiffness = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$motionone$2f$generators$2f$dist$2f$spring$2f$defaults$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaults"].stiffness, damping = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$motionone$2f$generators$2f$dist$2f$spring$2f$defaults$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaults"].damping, mass = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$motionone$2f$generators$2f$dist$2f$spring$2f$defaults$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaults"].mass;
...
function pregenerateKeyframes(generator) {
    let toUnit = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$motionone$2f$utils$2f$dist$2f$noop$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["noopReturn"];
...
;
const glide = (param)=>{
    let { from = 0, velocity = 0.0, power = 0.8, decay = 0.325, bounceDamping, bounceStiffness, changeTarget, min, max, restDistance = 0.5, restSpeed } = param;
...
//# sourceMappingURL=node_modules_e0052b3d._.js.map